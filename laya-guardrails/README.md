...
The companion Python server requires Laya and [uv](https://docs.astral.sh/uv/). From the repository root:
...
Install this extension directory as a local Pi package:
...
```bash
cd /absolute/path/to/laya-playground/laya-server
